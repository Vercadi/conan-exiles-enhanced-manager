...
def build_needs_attention(
    ...
    *,
    ...
    if dedicated_server_enabled and paths.dedicated_server_root and not paths.dedicated_server_config_dir:
    ...
    if dedicated_server_enabled and paths.dedicated_server_root and not paths.dedicated_server_save_databases():
        items.append("No dedicated server save database files found.")
    if dedicated_server_enabled and server_runtime and server_runtime.restart_recommended:
